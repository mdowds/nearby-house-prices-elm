...
var _user$project$NearbyHousePrices$loadingIndicator = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Waiting for location...'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$NearbyHousePrices$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$NearbyHousePrices$loadingIndicator,
			_1: {
				ctor: '::',
...
var _user$project$NearbyHousePrices$Model = F6(
	function (a, b, c, d, e, f) {
		return {averagePrice: a, numberOfTransactions: b, detachedAverage: c, flatAverage: d, semiDetachedAverage: e, terracedAverage: f};
	});
var _user$project$NearbyHousePrices$model = A6(_user$project$NearbyHousePrices$Model, 'Loading', 'Loading', 'Loading', 'Loading', 'Loading', 'Loading');
var _user$project$NearbyHousePrices$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_user$project$NearbyHousePrices$view(_user$project$NearbyHousePrices$model));
